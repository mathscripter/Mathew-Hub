...
if getgenv().MATHEWHubLoaded then
    if getgenv().MATHEWHubGui then getgenv().HansHubGui:Destroy() end
end
getgenv().MATHHubLoaded = true
...
--  SETTINGS
-- ============================================================
local SAVE_FILE = "MATHHub_v5_Settings.json"
...
task.delay(0.5, function()
    Notify("✨ MATH Hub v5.0","Loaded! INSERT = menu | F = fly toggle",4)
end)